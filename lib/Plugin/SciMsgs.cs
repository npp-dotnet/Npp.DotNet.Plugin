...
{
    /// <summary>Definitions for Scintilla 5.6.1</summary>
    /// <remarks>Autogenerated 2026-04-26</remarks>
    public enum SciMsg : uint
    {
        ...
        [Obsolete("Use the INDICATOR_* range numbers instead: https://www.scintilla.org/ScintillaDoc.html#Indicators")]
        INDIC_CONTAINER = 8,
        [Obsolete("Use the INDICATOR_* range numbers instead: https://www.scintilla.org/ScintillaDoc.html#Indicators")]
        INDIC_IME = 32,
        [Obsolete("Use the INDICATOR_* range numbers instead: https://www.scintilla.org/ScintillaDoc.html#Indicators")]
        ...
        /// <summary>
        /// SCI_AUTOCSETIMAGESCALE(int scalePercent)<br/>
        /// </summary>
        SCI_AUTOCSETIMAGESCALE = 2815,
        /// <summary>
        /// SCI_AUTOCGETIMAGESCALE -&gt; int<br/>
        /// Get or set the scale factor in percent for all autocompletion list images. This is useful on macOS with a
        /// retina display where each display unit is 2 pixels: use a factor of 200 so that each image pixel is displayed using a
        /// screen pixel. The default scale, 100, will stretch each image pixel to cover 4 screen pixels on a retina display.
        /// </summary>
        ...
        /// <summary>
        /// SCI_SETUNDOSELECTIONHISTORY(int undoSelectionHistory)<br/>
        /// </summary>
        SCI_SETUNDOSELECTIONHISTORY = 2782,
        /// <summary>
        /// SCI_GETUNDOSELECTIONHISTORY -&gt; int<br/>
        /// The selection for each action can be saved and then restored when undo or redo is performed.
        /// SCI_SETUNDOSELECTIONHISTORY controls this. There is a memory cost for this feature with a minimum of 150 bytes
        /// for each of undo and redo for each recorded action. Recording may be turned on at any time.
        /// </summary>
        SCI_GETUNDOSELECTIONHISTORY = 2783,
        /// <summary>
        /// SCI_SETSELECTIONSERIALIZED(&lt;unused&gt;, const char ＊selectionString)<br/>
        /// </summary>
        SCI_SETSELECTIONSERIALIZED = 2784,
        /// <summary>
        /// SCI_GETSELECTIONSERIALIZED(&lt;unused&gt;, char ＊selectionString) -&gt; position<br/>
        /// Set or query the selection type and positions as a serialized string. The format of this string may change in
        /// future versions so should not be persisted beyond the current session.
        /// </summary>
        ...
        SCI_LINESCROLL = 2168,
        /// <summary>
        /// SCI_SCROLLVERTICAL(line docLine, line subLine)<br/>
        ...
        /// choice is SC_TECHNOLOGY_DEFAULT (0). On Windows 7 or later, SC_TECHNOLOGY_DIRECTWRITE (1) performs higher
        /// quality antialiased drawing. The other choices in the following table are similar to SC_TECHNOLOGY_DIRECTWRITE
        ...
        /// <summary>
        /// SCI_GETDRAGDROPENABLED -&gt; bool<br/>
        /// </summary>
        SCI_GETDRAGDROPENABLED = 2818,
        /// <summary>
        /// SCI_SETDRAGDROPENABLED(bool dragDropEnabled)<br/>
        ...
        /// <summary>
        /// SCI_GETPROPERTYEXPANDED(const char ＊key, char ＊value NUL-terminated) -&gt; int<br/>
