...
namespace Npp.DotNet.Plugin.Winforms
{
    ...
    {
        public static readonly Color SlightlyDarkControl = Color.FromArgb(
        ...
        public static void ApplyStyle(Control ctrl, bool useNppStyle, bool darkMode = false)
        {
            ...
            if (!NppUtils.NppVersionAtLeast8)
            ...
            Color backColor = DialogUtils.NotepadGUI.GetDefaultBackgroundColor();
            if (!useNppStyle || (
                backColor.R > 240 &&
                backColor.G > 240 &&
                backColor.B > 240))
            ...
            Color foreColor = DialogUtils.NotepadGUI.GetDefaultForegroundColor();
