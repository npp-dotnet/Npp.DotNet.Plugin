...
{
    /// <summary>Definitions for Scintilla 5.5.0</summary>
    /// <remarks>Autogenerated 2024-05-10</remarks>
    [Flags]
    public enum SciMsg : uint
    {
        ...
        /// for the 7 logical symbols used to denote folding. You can assign a wide range of symbols and colours to each of
        ...
        /// releases any extended styles allocated by the container. SCI_ALLOCATEEXTENDEDSTYLES allocates a range of style
        /// numbers after the byte style values and returns the number of the first allocated style. Ranges for margin
        /// and annotation styles should be allocated before calling SCI_MARGINSETSTYLEOFFSET or
