...
namespace Npp.DotNet.Plugin
{
    ...
    public enum SciMsg : uint
    {
        ...
        /// This inserts the first length characters from the string text at the current position. This will include any 0's in
        /// the string that you might have expected to stop the insert operation. The current position is set at the end of the
        ...
        /// This inserts the zero terminated text string at position pos or at the current position if pos is -1. If the
        /// current position is after the insertion point then it is moved along with its surrounding text but no scrolling is
        /// performed.
        /// </summary>
        SCI_INSERTTEXT = 2003,
        /// <summary>
        ...
        /// SCI_GETSTYLEAT may return a negative number for styles over 127 whereas will only return positive numbers. should be
        /// preferred as it handles styles more consistently and may avoid problems with lexers that define more than 128
        /// styles.
        /// </summary>
        ...
        /// each pair and the style byte at the upper address. Characters between the positions cpMin and cpMax are copied
        /// to lpstrText (see struct Sci_TextRange and struct Sci_TextRangeFull in Scintilla.h ). Two 0 bytes are added to
        /// the end of the text, so the buffer that lpstrText points at must be at least 2*(cpMax-cpMin)+2 bytes long. No
        /// check is made for sensible values of cpMin or cpMax. Positions outside the document return character codes and
        /// style bytes of 0.
        /// </summary>
        ...
        /// The markerHandle argument is an identifier for a marker returned by SCI_MARKERADD. This function searches the
        /// document for the marker with this handle and returns the line number that contains it or -1 if it is not found.
        /// </summary>
        ...
        /// You can control whether Scintilla collects undo information with SCI_SETUNDOCOLLECTION. Pass in true (1) to collect
        /// information and false (0) to stop collecting. If you stop collection, you should also use SCI_EMPTYUNDOBUFFER to
        /// avoid the undo buffer being unsynchronized with the data in the buffer.
        /// </summary>
        ...
        /// These two messages get and set how tab characters are drawn when white space is visible. The tabDrawMode argument
        /// can be one of:
        /// </summary>
        ...
        /// SCI_POSITIONFROMPOINT finds the closest character position to a point and is similar but returns -1 if the point is
        /// outside the window or not close to any characters.
        /// </summary>
        SCI_POSITIONFROMPOINTCLOSE = 2023,
        /// <summary>
        /// SCI_GOTOLINE(line line)<br/>
        /// This removes any selection and sets the caret at the start of line number line and scrolls the view (if needed) to
        /// make it visible. The anchor position is set the same as the current position. If line is outside the lines in the
        ...
        /// It is equivalent to SCI_SETSEL(caret, caret). The anchor position is set the same as the current position.
        /// </summary>
        SCI_GOTOPOS = 2025,
        /// <summary>
        ...
        /// notification message is sent to the container. The container can send to work out where it needs to start
        /// styling. Scintilla will always ask to style whole lines.
        /// </summary>
        ...
        /// set eolMode to one of SC_EOL_CRLF (0), SC_EOL_CR (1), or SC_EOL_LF (2). The message retrieves the current
        /// state.
        /// </summary>
        SCI_GETEOLMODE = 2030,
        /// <summary>
        ...
        /// earlier versions but is now ignored. After, send multiple SCI_SETSTYLING messages for each lexical entity
        /// to style or send SCI_SETSTYLINGEX to style in blocks.
        /// </summary>
        ...
        /// position by length, ready for the next call. SCI_STARTSTYLING should be called before the first call to this.
        /// </summary>
        SCI_SETSTYLING = 2033,
        /// <summary>
        ...
        /// SCI_CLEARTABSTOPS clears explicit tabstops on a line. SCI_ADDTABSTOP adds an explicit tabstop at the specified
        /// distance from the left (in pixels), and gets the next explicit tabstop position set after the given x position, or
        /// zero if there aren't any. Changing tab stops produces a SC_MOD_CHANGETABSTOPS notification.
        /// </summary>
        ...
        /// is a choice between the two techniques. A windowed IME SC_IME_WINDOWED (0) may be more similar in appearance and
        /// behaviour to the IME in other applications. An inline IME SC_IME_INLINE (1) may work better with some Scintilla
        /// features such as rectangular and multiple selection, with IME interactions such as retrieve-surrounding or
        ...
        /// The general-purpose marker symbols currently available are: SC_MARK_CIRCLE, SC_MARK_ROUNDRECT, SC_MARK_ARROW ,
        /// SC_MARK_SMALLRECT, SC_MARK_SHORTARROW, SC_MARK_EMPTY, SC_MARK_ARROWDOWN, SC_MARK_MINUS, SC_MARK_PLUS ,
        /// SC_MARK_ARROWS, SC_MARK_DOTDOTDOT, SC_MARK_BACKGROUND, SC_MARK_LEFTRECT, SC_MARK_FULLRECT ,
        /// SC_MARK_BOOKMARK, SC_MARK_VERTICALBOOKMARK, SC_MARK_UNDERLINE, and SC_MARK_BAR .
        /// </summary>
        ...
        /// returned handle with SCI_MARKERLINEFROMHANDLE to find where a marker is after moving or combining lines and with
        /// SCI_MARKERDELETEHANDLE to delete the marker based on its handle. The message does not check the value of
        ...
        /// lineStart and continues forwards to the end of the file( SCI_MARKERNEXT) or backwards to the start of the file
        /// ( ). The markerMask argument should have one bit set for each marker you wish to find. Set bit 0 to find marker
        /// 0, bit 1 for marker 1 and so on. The message returns the line number of the first line that contains one of the
        /// markers in markerMask or -1 if no marker is found.
        /// </summary>
        ...
        /// integer format returned by SCI_MARKERGET (and used by the mask-based marker search functions SCI_MARKERNEXT and
        /// SCI_MARKERPREVIOUS ). As with SCI_MARKERADD, no check is made to see if any of the markers are already
        ...
        /// predefined constants SC_MARGIN_SYMBOL (0) and SC_MARGIN_NUMBER (1) to set a margin as either a line number or a
        /// symbol margin. A margin with application defined text may use SC_MARGIN_TEXT (4) or SC_MARGIN_RTEXT (5) to
        /// right justify the text. By convention, margin 0 is used for line numbers and the next two are used for symbols. You
        /// can also use the constants SC_MARGIN_BACK (2), SC_MARGIN_FORE (3), and SC_MARGIN_COLOUR (6) for
        /// symbol margins that set their background colour to match the STYLE_DEFAULT background and foreground colours or a
        /// specified colour.
        /// </summary>
        ...
        /// that is enabled for symbols. There is a useful constant, SC_MASK_FOLDERS (0xFE000000 or -33554432), that is a mask for
        /// the 7 logical symbols used to denote folding. You can assign a wide range of symbols and colours to each of
        /// the 32 logical symbols, see Markers for more information. If (mask &amp; SC_MASK_FOLDERS)==0, the margin
        ...
        /// to true and a consistent background colour (different from the background colour set for the HTML styles) to all
        /// JavaScript styles then JavaScript sections will be easily distinguished from HTML.
        /// </summary>
        ...
        /// The value of caseVisible determines how text is displayed. You can set upper case( SC_CASE_UPPER, 1) or lower
        /// case( SC_CASE_LOWER, 2) or camel case( SC_CASE_CAMEL, 3) or display normally( SC_CASE_MIXED, 0). This
        /// does not change the stored text, only how it is displayed.
        /// </summary>
        ...
        /// SC_CHARSET_RUSSIAN) would ensure that strings in Russian would display correctly in C and C++( SCE_C_STRING is
        /// the style number used by the C and C++ lexer to display literal strings; it has the value 6). This feature
        ...
        /// This is an experimental and incompletely implemented style attribute. The default setting is changeable set true but
        /// when set false it makes text read-only. The user can not move the caret within not-changeable text and not-
        ...
        /// They are commonly defined as grey to highlight that it is the selection in the other application that is now available
        /// as primary.
        /// </summary>
        ...
        /// SC_ELEMENT_SELECTION_INACTIVE_TEXT and -&gt; SC_ELEMENT_SELECTION_INACTIVE_BACK .
        /// </summary>
        ...
        /// text area. The lines are drawn in the colour if set. If it is not set then the foreground colour set for
        /// STYLE_DEFAULT is used. Bits set in flags determine where folding lines are drawn:
        /// </summary>
        ...
        /// SC_ELEMENT_CARET_LINE_BACK element with SCI_SETELEMENTCOLOUR(SC_ELEMENT_CARET_LINE_BACK). This effect may be
        /// drawn translucently over the text or opaquely on the base layer with SCI_SETCARETLINELAYER. Background colouring
        /// has highest priority when a line has markers that would otherwise change the background colour. When drawn
        /// translucently other background colours can show through. The layer argument can be one of:
        /// </summary>
        ...
        /// default value is 500 milliseconds. returns the current setting.
        /// </summary>
        ...
        /// This fills the characters parameter with all the characters included in words. The characters parameter must
        /// be large enough to hold all of the characters. If the characters parameter is 0 then the length that should be
        /// allocated to store the entire set is returned.
        /// </summary>
        ...
        /// setting but instead from the value of the indicator at that point in the file. SC_INDICFLAG_NONE is the default.
        /// This allows many colours to be displayed for a single indicator. The value is an RGB integer colour that has been ored
        /// with SC_INDICVALUEBIT (0x1000000) when calling SCI_SETINDICATORVALUE. To find the colour from the value,
        /// and the value with SC_INDICVALUEMASK (0xFFFFFF).
        /// </summary>
        ...
        /// supporting stroke width are: INDIC_PLAIN, INDIC_SQUIGGLE, INDIC_TT, INDIC_DIAGONAL, INDIC_STRIKE ,
        /// INDIC_BOX, INDIC_ROUNDBOX, INDIC_STRAIGHTBOX, INDIC_FULLBOX, INDIC_DASH, INDIC_DOTS, INDIC_SQUIGGLELOW
        /// .
        /// </summary>
        ...
        /// and SC_ELEMENT_WHITE_SPACE_BACK. . SCI_SETWHITESPACEFORE and also change the white space colours but
        /// the element APIs are preferred with SC_ELEMENT_WHITE_SPACE allowing translucency.
        /// </summary>
        ...
        /// SCI_SETWHITESPACESIZE sets the size of the dots used for mark space characters. The message retrieves the
        /// current size. The value 0 is valid and makes the dots invisible.
        /// </summary>
        ...
        /// SCI_SETLINESTATE to set the integer value and to get the value. Changing the value produces a
        ...
        /// SCI_SETCARETLINEFRAME can be used to display the caret line framed instead of filling the whole background.
        ...
        /// This message causes a list to be displayed. lengthEntered is the number of characters of the word already entered
        /// and itemList is the list of words separated by separator characters. The initial separator character is a space
        /// but this can be set or got with SCI_AUTOCSETSEPARATOR and SCI_AUTOCGETSEPARATOR .
        /// </summary>
        SCI_AUTOCSHOW = 2100,
        ...
        /// The listType parameter is returned to the container as the wParam field of the SCNotification structure. It must
        /// be greater than 0 as this is how Scintilla tells the difference between an autocompletion list and a user list. If
        /// you have different types of list, for example a list of buffers and a list of macros, you can use listType to
        ...
        /// 0, the indent size is the same as the tab size. There are no limits on indent sizes, but values less than 0 or
        ...
        /// purely on spaces. Set useTabs to false (0) to create all tabs and indents out of spaces. The default is true. You
        /// can use SCI_GETCOLUMN to get the column of a position taking the width of a tab into account.
        /// </summary>
        SCI_GETUSETABS = 2125,
        /// <summary>
        ...
        /// The amount of indentation on a line can be discovered and set with and SCI_SETLINEINDENTATION. The indentation is
        ...
        /// call SCI_SETHSCROLLBAR(0). Use SCI_SETHSCROLLBAR(1) to enable it again. returns the current state. The default
        ...
        /// This returns the position at the end of the line, before any line end characters. If line is the last line in the
        /// document (which does not have any end of line characters) or greater, the result is the size of the document.
        ...
        /// SC_CP_UTF8) is the default. Use this message with codePage set to the code page number to set Scintilla to use code
        /// page information to ensure multiple byte characters are treated as one character rather than multiple. This also
        /// stops the caret from moving between the bytes in a multi-byte character. Do not use this message to choose
        /// between different single byte character sets- use SCI_STYLESETCHARACTERSET. Call with codePage set to zero to
        /// disable multi-byte support.
        /// </summary>
        SCI_GETCODEPAGE = 2137,
        /// <summary>
        /// SCI_GETCARETFORE -&gt; colour<br/>
        /// The colour of the caret can be set with SCI_SETELEMENTCOLOUR(SC_ELEMENT_CARET) or SCI_SETCARETFORE and retrieved
        /// with SCI_GETELEMENTCOLOUR(SC_ELEMENT_CARET) or. The element APIs are preferred and allow setting the
        /// translucency of carets.
        /// </summary>
        [Obsolete("Use the element colours APIs instead: https://www.scintilla.org/ScintillaDoc.html#ElementColours")]
        ...
        /// the anchor. SCI_GETSELECTIONSTART returns the smaller of the current position or the anchor position. returns
        ...
        /// lets you to print at a different size than the screen font. magnification is the number of points to add to the
        /// size of each screen font. A value of -3 or -4 gives reasonably small print. You can get this value with .
        /// </summary>
        ...
        /// This copies the currently selected text and a terminating NUL(0) byte to the text buffer. The buffer size should be
        /// determined by calling with a NULL pointer for the text argument: 1+ SCI_GETSELTEXT(0, NULL). This allows for
        /// rectangular and discontiguous selections as well as simple selections. See Multiple Selection for information on
        ...
        /// Sci_TextRange in Scintilla.h ). If cpMax is -1, text is returned to the end of the document. The text is 0
        /// terminated, so you must supply a buffer that is at least 1 character longer than the number of characters you wish
        /// to read. The return value is the length of the returned text not including the terminating 0.
        /// </summary>
        ...
        /// the secondary position. The behaviour is similar to SCI_SCROLLCARET with the primary position used instead of
        /// the caret. An effort is then made to ensure that the secondary position and range between are also visible.
        ...
        /// <summary>
        /// SCI_CANUNDO -&gt; bool<br/>
        /// SCI_UNDO undoes one action, or if the undo buffer has reached a SCI_ENDUNDOACTION point, all the actions back to the
        /// corresponding SCI_BEGINUNDOACTION .
        /// </summary>
        SCI_CANUNDO = 2174,
        ...
        /// SCI_GETLENGTH to get the number of characters in the document( nLen ), allocate a character buffer of length
        /// nLen+1 bytes, then call SCI_GETTEXT(nLen, char *text). If the text argument is NULL(0) then the length that
        /// should be allocated to store the entire document is returned. If you then save the text, you should use
        ...
        /// is disabled, characters are inserted at the caret. returns true (1) if overtyping is active, otherwise false (0)
        /// will be returned. Use SCI_SETOVERTYPE to set the overtype mode.
        /// </summary>
        ...
        /// width is 1 pixel. You can read back the current width with. A width of 0 makes the caret invisible, similar to
        /// setting the caret style to CARETSTYLE_INVISIBLE (though not interchangeable). This setting only affects the width
        /// of the cursor when the cursor style is set to line caret mode, it does not affect the width for a block caret.
        /// </summary>
        ...
        /// with SCI_SETTARGETSTART, SCI_SETTARGETEND, or sets the virtual space to 0. The target is also set by a
        /// successful SCI_SEARCHINTARGET .
        /// </summary>
        ...
        /// If length is -1, text is a zero terminated string, otherwise length sets the number of character to replace the
        /// target with. After replacement, the target range refers to the replacement text. The return value is the
        /// length of the replacement string. Note that the recommended way to delete text in the document is to set the target
        /// to the text to be removed, and to perform a replace target with an empty string.
        /// </summary>
        SCI_REPLACETARGET = 2194,
        /// <summary>
        /// SCI_REPLACETARGETRE(position length, const char *text) -&gt; position<br/>
        /// This replaces the target using regular expressions. If length is -1, text is a zero terminated string, otherwise
        /// length is the number of characters to use. The replacement string is formed from the text string with any
        /// sequences of \1 through \9 replaced by tagged matches from the most recent regular expression search. \0 is
        /// replaced with all the matched text from the most recent search. After replacement, the target range refers to the
        ...
        /// This is similar to SCI_REPLACETARGET but tries to minimize change history when the current target text shares a common
        /// prefix or suffix with the replacement. Only the text that is actually different is marked as changed. This
        /// might be used when automatically reformatting some text so that the whole area formatted doesn't show change marks.
        /// If length is -1, text is a zero terminated string, otherwise length sets the number of character to replace the
        /// target with. After replacement, the target range refers to the replacement text. The return value is the
        /// length of the replacement string. Note that the recommended way to delete text in the document is to set the target
        /// to the text to be removed, and to perform a replace target with an empty string.
        ...
        /// SCI_SETTARGETEND. The text string is not zero terminated; the size is set by length. The search is modified by
        /// the search flags set by SCI_SETSEARCHFLAGS. If the search succeeds, the target is set to the found text and
        /// the return value is the position of the start of the matching text. If the search fails, the result is -1.
        /// </summary>
        ...
        /// These get and set the searchFlags used by SCI_SEARCHINTARGET. There are several option flags including a simple
        ...
        /// the highlight. highlightEnd must be greater than highlightStart; highlightEnd-highlightStart is the number
        /// of characters to highlight. Highlights can extend over line ends if this is required.
        /// </summary>
        ...
        /// pixels. If tabsize is less than 1, Tab characters are not treated specially. Once this call has been used, the
        ...
        /// first line in the document is 0. If lines are hidden and docLine is outside the range of lines in the document, the
        /// return value is -1. Lines can occupy more than one display line if they wrap.
        /// </summary>
        ...
        /// is less than or equal to 0, the result is 0. If displayLine is greater than or equal to the number of displayed lines,
        /// the result is the number of lines in the document.
        /// </summary>
        ...
        /// folding. The fold level is a number in the range 0 to SC_FOLDLEVELNUMBERMASK (0x0FFF). However, the initial fold level
        /// is set to SC_FOLDLEVELBASE (0x400) to allow unsigned arithmetic on folding levels. There are two addition flag
        /// bits. SC_FOLDLEVELWHITEFLAG indicates that the line is blank and allows it to be treated slightly different then
        /// its level may indicate. For example, blank lines should generally not be fold points and will be considered part of
        /// the preceding section even though they may have a lesser fold level. SC_FOLDLEVELHEADERFLAG indicates that the
        /// line is a header (fold point). SC_FOLDLEVELNONE is a default level that may occur before folding.
        /// </summary>
        ...
        /// level and then returns the previous line number. If you set level to -1, level is set to the folding level of
        /// line line. If from is a fold point, SCI_GETLASTCHILD(from, -1) returns the last line that would be in made
        /// visible or hidden by toggling the fold state.
        /// </summary>
        ...
        /// SC_FOLDLEVELHEADERFLAG and has a fold level less than the line. If no line is found, or if the header flags and
        ...
        /// SC_ELEMENT_HIDDEN_LINE is set then a horizontal line is drawn in that colour to indicate that there are hidden lines.
        /// A fold line drawn in that position overrides the hidden line indicator. SCI_GETLINEVISIBLE reports on the visible
        /// state of a line and returns 1 if it is visible and 0 if it is not visible. returns 1 if all lines are visible and
        /// 0 if some lines are hidden. These messages have no effect on fold levels or fold flags.
        /// </summary>
        ...
        /// These messages toggle the folding state of the given line as long as it has the SC_FOLDLEVELHEADERFLAG set. These
        /// messages take care of folding or expanding all the lines that depend on the line. The display updates after this
        /// message.
        /// </summary>
        ...
        /// structure. SC_AUTOMATICFOLD_CLICK is more likely to be set off when an application would like to add or change
        /// click behaviour such as showing method headers only when Shift+Alt is used in conjunction with a click.
        /// </summary>
        ...
        /// you use, the vertical caret policy set by SCI_SETVISIBLEPOLICY is then applied.
        /// </summary>
        ...
        /// displaying it. On very large files, this may make scrolling down slow. With SC_IDLESTYLING_TOVISIBLE (1),
        /// a small amount of styling is performed before display and then further styling is performed incrementally in the
        /// background as an idle-time task. This may result in the text initially appearing uncoloured and then, some time
        /// later, it is coloured. Text after the currently visible portion may be styled in the background with
        /// SC_IDLESTYLING_AFTERVISIBLE (2). To style both before and after the visible text in the background use
        /// SC_IDLESTYLING_ALL (3).
        /// </summary>
        ...
        /// SC_WRAP_NONE (0) to disable line wrapping. SC_WRAP_CHAR is preferred for Asian languages where there is
        ...
        /// average character width in STYLE_DEFAULT. There are no limits on indent sizes, but values
        /// less than 0 or large values may have undesirable effects. The indention of sublines is independent
        /// of visual flags, but if SC_WRAPVISUALFLAG_START is set an indent of at least 1 is used.
        /// </summary>
        ...
        /// SCI_SETVSCROLLBAR and get the current state with .
        /// </summary>
        SCI_GETVSCROLLBAR = 2281,
        /// <summary>
        /// SCI_APPENDTEXT(position length, const char *text)<br/>
        /// This adds the first length characters from the string text to the end of the document. This will include any
        /// 0's in the string that you might have expected to stop the operation. The current selection is not changed and the
        /// new text is not scrolled into view.
        /// </summary>
        SCI_APPENDTEXT = 2282,
        SC_PHASES_ONE = 0,
        SC_PHASES_TWO = 1,
        ...
        /// SC_EFF_QUALITY_DEFAULT (backward compatible), SC_EFF_QUALITY_NON_ANTIALIASED, SC_EFF_QUALITY_ANTIALIASED ,
        ...
        /// This returns the length of the line, including any line end characters. If line is negative or beyond the last line in
        /// the document, the result is 0. If you want the length of the line not including any end of line characters, use
        ...
        /// If there is no matching brace then the brace badlighting style, style STYLE_BRACEBAD (35), can be used to show
        /// the brace that is unmatched. Using a position of INVALID_POSITION (-1) removes the highlight.
        /// </summary>
        ...
        /// The message finds a corresponding matching brace given pos, the position of one brace. The brace characters handled
        /// are '(', ')', '[', ']', '{', '}', '&lt;', and '&gt;'. The search is forwards from an opening brace and backwards
        /// from a closing brace. If the character at position is not a brace character, or a matching brace cannot be found,
        ...
        /// Similar to SCI_BRACEMATCH, but matching starts at the explicit start position startPos instead of the implicitly
        /// next position pos± 1 .
        /// </summary>
        ...
        /// setting visible true (or false ). The visible rendering of the end of line characters is similar to (CR), (LF)
        /// , or (CR)(LF). returns the current state.
        /// </summary>
        SCI_GETVIEWEOL = 2355,
        /// <summary>
        ...
        /// This message does the following: 1. It removes the current window from the list held by the current document. 2.
        /// It reduces the reference count of the current document by 1. 3. If the reference count reaches 0, the document is
        ...
        /// cleared with SCI_MULTIEDGECLEARALL. returns the column of the Nth vertical edge (indexed from 0). If which is
        /// greater or equal to the number of vertical edges, this returns -1.
        /// </summary>
        ...
        /// to allocate once rather than rely on the buffer growing as data is added. If fails then 0 is returned.
        /// </summary>
        ...
        /// the following: 1. Use SCI_GETDOCPOINTER to get a pointer to the document, doc. 2. Use SCI_ADDREFDOCUMENT(0,
        /// doc) to increment the reference count. 3. Use SCI_SETDOCPOINTER(0, docNew) to set a different document or
        ...
        /// the world spinning in its orbit you must balance each call to SCI_CREATEDOCUMENT or SCI_ADDREFDOCUMENT with a
        /// call to .
        /// </summary>
        ...
        /// with SCN_MODIFIED and SCEN_CHANGE. For example, a container may decide to see only notifications about changes
        ...
        /// These messages set and get whether SCEN_* command events are sent to the container. For SCEN_CHANGE this acts
        /// as an additional filter over SCI_SETMODEVENTMASK. Most applications should set this off to avoid overhead and
        /// only use SCN_MODIFIED .
        /// </summary>
        ...
        /// If an error occurs, Scintilla may set an internal error number that can be retrieved with. To clear the error
        /// status call SCI_SETSTATUS(0). Status values from 1 to 999 are errors and status SC_STATUS_WARN_START (1000)
        ...
        /// of the style set for the character. You can read back the current symbol with the message. The default symbol
        /// value is 0.
        /// </summary>
        ...
        /// takes VISIBLE_SLOP and VISIBLE_STRICT flags for the visiblePolicy parameter. It is similar in operation to
        ...
        /// The xOffset is the horizontal scroll position in pixels of the start of the text view. A value of 0 is the normal
        /// position with the first text column visible at the left of the view.
        /// </summary>
        SCI_GETXOFFSET = 2398,
        ...
        /// These set the caret policy. The value of caretPolicy is a combination of CARET_SLOP, CARET_STRICT, CARET_JUMPS
        /// and CARET_EVEN .
        /// </summary>
        ...
        /// SCI_COPYRANGE copies a range of text from the document to the system clipboard and copies a supplied piece of
        ...
        /// called after SCI_SETWORDCHARS as it will reset the whitespace characters to the default set. behaves
        ...
        /// Scintilla considers as punctuation. behaves similarly to SCI_GETWORDCHARS .
        /// </summary>
        ...
        /// ). The current selection index can be retrieved with .
        /// </summary>
        ...
        /// property of SC_CASEINSENSITIVEBEHAVIOUR_RESPECTCASE (0). If you want autocompletion to ignore case at all, choose
        /// SC_CASEINSENSITIVEBEHAVIOUR_IGNORECASE (1).
        /// </summary>
        ...
        /// text can contain nul bytes, the method can be used to set the length that will be converted. If set to -1,
        /// the length is determined by finding a nul byte. The length of the converted string is returned.
        /// </summary>
        ...
        /// This message returns the position of a column on a line taking the width of tabs into account. It treats a multi-
        /// byte character as a single column. Column numbers, like lines start at 0.
        /// </summary>
        SCI_FINDCOLUMN = 2456,
        ...
        /// These APIs are discouraged. It is better to use the SC_ELEMENT_CARET_LINE_BACK element mentioned in the previous
        /// section. You can choose to make the background colour of the line containing the caret different with these
        /// messages. To do this, set the desired background colour with SCI_SETCARETLINEBACK, then use
        /// SCI_SETCARETLINEVISIBLE(true) to enable the effect. You can cancel the effect with SCI_SETCARETLINEVISIBLE(false)
        /// . The two SCI_GETCARET* functions return the state and the colour. This form of background colouring has
        /// highest priority when a line has markers that would otherwise change the background colour. The caret
        /// line may also be drawn translucently which allows other background colours to show through. This is done by
        /// setting the alpha (translucency) value by calling SCI_SETCARETLINEBACKALPHA. When the alpha is not
        /// SC_ALPHA_NOALPHA, the caret line is drawn after all other features so will affect the colour of all other
        /// features.
        /// </summary>
        [Obsolete("Use the element colours APIs instead: https://www.scintilla.org/ScintillaDoc.html#ElementColours")]
        ...
        /// 4-bits, CARETSTYLE_INS_MASK ), overtype mode (bit 4), and curses mode (bit 5). CARETSTYLE_INVISIBLE
        /// CARETSTYLE_LINE CARETSTYLE_BLOCK CARETSTYLE_OVERSTRIKE_BAR CARETSTYLE_OVERSTRIKE_BLOCK CARETSTYLE_CURSES
        /// CARETSTYLE_BLOCK_AFTER CARETSTYLE_BLOCK or CARETSTYLE_CURSES. The block caret draws most combining and multibyte
        ...
        /// overlap styles set by lexers. Each style number set with SCI_MARGINSETSTYLE or SCI_MARGINSETSTYLES has the offset
        ...
        /// They are outside the range 0..255 used for the styles bytes associated with document bytes. These functions manage
        /// the use of extended styles to ensures that components cooperate in defining styles. SCI_RELEASEALLEXTENDEDSTYLES
        /// releases any extended styles allocated by the container. allocates a range of style numbers after the byte style values
        /// and returns the number of the first allocated style. Ranges for margin and annotation styles should be
        /// allocated before calling SCI_MARGINSETSTYLEOFFSET or SCI_ANNOTATIONSETSTYLEOFFSET .
        /// </summary>
        ...
        /// The container can add its own actions into the undo stack by calling and an SCN_MODIFIED notification will be sent to
        /// the container with the SC_MOD_CONTAINER flag when it is time to undo( SC_PERFORMED_UNDO) or redo (
        /// SC_PERFORMED_REDO) the action. The token argument supplied is returned in the token field of the notification.
        /// </summary>
        ...
        /// SCI_CHARPOSITIONFROMPOINT finds the closest character to a point and is similar but returns -1 if the point is outside
        /// the window or not close to any characters. This is similar to the previous methods but finds characters rather than
        ...
        /// appearance set with SC_ELEMENT_CARET, SCI_SETCARETFORE, SCI_GETCARETFORE, SCI_SETCARETPERIOD, and
        /// SCI_GETCARETPERIOD .
        /// </summary>
        ...
        /// be added with SCI_SETSELECTION and later selections added with
        /// </summary>
        ...
        /// are three bit flags SCVS_RECTANGULARSELECTION =1, SCVS_USERACCESSIBLE =2, and SCVS_NOWRAPLINESTART =4 which can be
        /// set independently. SCVS_NONE =0, the default, disables all use of virtual space.
        /// </summary>
        ...
        /// appearance set with SC_ELEMENT_SELECTION_TEXT, SC_ELEMENT_SELECTION_BACK, SCI_SETSELALPHA, SCI_GETSELALPHA ,
        /// SCI_SETSELFORE, and SCI_SETSELBACK. The element APIs are preferred and the following messages discouraged.
        /// The additional selection background is drawn on the layer defined for all selection backgrounds by
        /// SCI_SETSELECTIONLAYER. SCI_SETADDITIONALSELFORE and calls have no effect until SCI_SETSELFORE and
        /// SCI_SETSELBACK are called with useSetting value set to true. Subsequent calls to SCI_SETSELFORE, and
        /// SCI_SETSELBACK will overwrite the values set by SCI_SETADDITIONALSEL* functions.
        /// </summary>
        [Obsolete("Use the element colours APIs instead: https://www.scintilla.org/ScintillaDoc.html#ElementColours")]
        ...
        /// forwards to the end of the file. lineStart is returned if it is a contracted fold header otherwise the next contracted
        ...
        /// idFrom field. When an application creates multiple Scintilla widgets, this allows the source of each notification
        /// to be found. On Windows, this value is initialised in the CreateWindow call and stored as the GWLP_ID
        /// attribute of the window. The value should be small, preferably less than 16 bits, rather than a pointer as
        /// some of the functions will only transmit 16 or 32 bits.
        /// </summary>
        ...
        /// SC_TECHNOLOGY_DIRECTWRITERETAIN (2), or SC_TECHNOLOGY_DIRECTWRITEDC (3) can be chosen to use the Direct2D and
        /// DirectWrite APIs for higher quality antialiased drawing. SC_TECHNOLOGY_DIRECTWRITERETAIN differs from
        /// SC_TECHNOLOGY_DIRECTWRITE by requesting that the frame is retained after being presented which may prevent drawing
        /// failures on some cards and drivers. SC_TECHNOLOGY_DIRECTWRITEDC differs from SC_TECHNOLOGY_DIRECTWRITE by using
        /// DirectWrite to draw into a GDI DC.
        /// </summary>
        ...
        /// data is added. If fails then 0 is returned.
        /// </summary>
        ...
        /// fades out after showing for half a second with. SCI_FINDINDICATORSHOW behaves similarly to the macOS TextEdit and
        /// Safari applications and is best suited to editing documentation where the search target is often a word. is
        /// similar to Xcode and is suited to editing source code where the match will often be located next to operators
        /// which would otherwise be hidden under the indicator's padding.
        /// </summary>
        ...
        /// SCI_SETLINEENDTYPESALLOWED(SC_LINE_END_TYPE_UNICODE) but this will be ineffective unless the lexer also allows you
        /// Unicode line ends. returns the current state.
        /// </summary>
        SCI_GETLINEENDTYPESALLOWED = 2657,
        /// <summary>
        /// SCI_GETLINEENDTYPESACTIVE -&gt; int<br/>
        /// reports the set of line ends currently interpreted by Scintilla. It is SCI_GETLINEENDTYPESSUPPORTED &amp;
        ...
        /// Different platforms support different features and can be used to check which are currently available. For
        /// example, on Win32, Direct2D supports drawing translucent lines but GDI does not so
        ...
        /// SC_LINECHARACTERINDEX_UTF32 (1) if whole characters are indexed or SC_LINECHARACTERINDEX_UTF16 (2) if UTF-16 code
        /// units are indexed. Character indexes are currently only supported for UTF-8 documents.
        /// </summary>
        ...
        /// SC_LINECHARACTERINDEX_UTF32 (1) or SC_LINECHARACTERINDEX_UTF16 (2). The inverse action, finds the starting
        /// position of a document line either in characters or code units from the document start by calling with the same
        /// lineCharacterIndex argument.
        /// </summary>
        ...
        /// and end. If end is -1, the document is styled from start to the end. If the "fold" property is set to "1" and
        /// your lexer or container supports folding, fold levels are also set. This message causes a redraw.
        /// </summary>
        SCI_COLOURISE = 4003,
        /// <summary>
        ...
        /// spaces, tabs, "\n" or "\r" or any combination of these. It is expected that the keywords will be composed of
        /// standard ASCII printing characters, but there is nothing to stop you using any non-separator character codes from 1
        /// to 255 (except common sense).
        /// </summary>
        ...
        /// returns the name of the current lexer which must be set with SCI_SETILEXER. To locate the name for a lexer, open
        /// the relevant lexilla/lexers/Lex*.cxx file and search for LexerModule. The third argument in the LexerModule
        ...
        /// SCI_PROPERTYTYPE. A description of a property in English is returned by .
        /// </summary>
        ...
        /// reports the different types of line ends supported by the current lexer. This is a bit set although there is
        /// currently only a single choice with either SC_LINE_END_TYPE_DEFAULT (0) or SC_LINE_END_TYPE_UNICODE (1).
        ...
        /// allows setting a lexer as an ILexer5*. The lexer may be implemented by an application or a shared library such
        /// as Lexilla.
        /// </summary>
        SCI_SETILEXER = 4033,
        SC_MOD_NONE = 0x0,
        ...
        /// <summary>
        /// SCI_SETLINESTATE was called. line
        /// </summary>
        ...
        /// <summary>
        /// SCI_ADDUNDOACTION . SC_MODEVENTMASKALL SCI_SETMODEVENTMASK . SCEN_CHANGE<br/>
        ...
        /// control( SCEN_CHANGE has the same value as the Windows Edit control EN_CHANGE ). No other information is sent.
        /// If you need more detailed information use SCN_MODIFIED. You can filter the types of changes you are
        /// notified about with SCI_SETMODEVENTMASK and SCI_SETCOMMANDEVENTS .
        /// </summary>
        ...
        /// <summary>
        /// SCI_CHANGEINSERTION . No other modifications may be made in this handler. position, length, text SC_MULTILINEUNDOREDO SC_STARTACTION
        /// </summary>
        SC_MOD_INSERTCHECK = 0x100000,
        /// <summary>
        /// SCI_CLEARTABSTOPS or SCI_ADDTABSTOP was called. line
        /// </summary>
